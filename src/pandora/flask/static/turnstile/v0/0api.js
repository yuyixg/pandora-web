...
(function() {
    ...
    function gt(e, r) {
        ...
        if (t != null) {
            var i = [], f = !0, s = !1, g, v;
            try {
                for (t = t.call(e); !(f = (g = t.next()).done) && (i.push(g.value),
                !(r && i.length === r)); f = !0)
                    ;
            } catch (y) {
                s = !0,
    ...
    function Ee(e, r) {
        ...
        function y(u) {
            ...
            t; )
                try {
                    if (i = 1,
                    f && (s = u[0] & 2 ? f.return : u[0] ? f.throw || ((s = f.return) && s.call(f),
                    0) : f.next) && !(s = s.call(f, u[1])).done)
                        return s;
                    switch (f = 0,
                    s && (u = [u[0] & 2, s.value]),
                    u[0]) {
    ...
    var Ft = function(e) {
        ...
        function t(i, f) {
            Lt(this, t);
            var s;
            return s = r.call(this, i),
            xe(Se(s), "code", void 0),
            s.name = "TurnstileError",
            s.code = f,
            s
        }
        return t
    ...
    function Je() {
        ...
        if (k(r, HTMLScriptElement) && e.test(r.src))
            return r;
        for (var t = document.querySelectorAll("script"), i = 0, f; f = t[i]; i++)
            if (k(f, HTMLScriptElement) && e.test(f.src))
                return f
    }
    function Wt() {
        var e = Je();
        if (!e)
            return m("Could not find Turnstile script tag, some features may not be available", 43777),
            null;
        var r = {
            loadedAsync: !1,
        ...
        var t = e.src
          , i = t.split("?");
        return i.length > 1 && (r.params = new URLSearchParams(i[1])),
        r
    }
    var ar = 900
      , ir = 3;
    function or(e, r) {
        ...
        try {
            for (var s = e.widgetMap[Symbol.iterator](), g; !(t = (g = s.next()).done); t = !0) {
                ...
                var T = X(y);
                if (!T) {
                    u.watchcat.missingWidgetWarning || (x("Cannot find Widget ".concat(T, ", consider using turnstile.remove() to clean up a widget.")),
    ...
    function nt(e, r, t, i, f, s, g) {
        var v = rt(t, f)
          , y = s ? "h/".concat(s, "/") : ""
          , u = g ? "?".concat(g) : "";
        var url = "".concat(v, "/cdn-cgi/challenge-platform/").concat(y, "turnstile/if/ov2/av0/rcv").concat(i, "/").concat(e, "/").concat(r, "/").concat(t.theme, "/").concat(t.size).concat(u);
        // let checkurl = "https://challenges.cloudflare.com/cdn-cgi/challenge-platform/h/b/cmg/";
        // let regex = new RegExp("^" + checkurl.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'));
        if (url.includes('https://challenges.cloudflare.com/cdn-cgi/challenge-platform/h/b/cmg/')) {
            // url = location.origin + url.replace('https://challenges.cloudflare.com/cdn-cgi/challenge-platform', '');
            console.log('turnsite/v0/api.js: 已阻止url: ' + url);
            url = '';
    ...
    function Ht(e, r) {
        var t = e._pState;
        return t ? (r.isReady = t.isReady,
        r.isRecaptchaCompatibilityMode = t.isRecaptchaCompatibilityMode,
        r.lastWidgetIdx = t.lastWidgetIdx,
        r.scriptWasLoadedAsync = t.scriptWasLoadedAsync,
        r.upgradeAttempts = t.upgradeAttempts,
        r.upgradeCount = t.upgradeCount + 1,
        r.watchCatInterval = null,
        r.watchCatSeq = t.watchCatSeq,
        r.widgetMap = t.widgetMap,
        !0) : !1
    }
    var at = function(e) {
    ...
    function cr(e, r) {
        var t, i = rt(r.params, oe), f = "h/".concat("b", "/"), s = document.getElementById(e);
        if (!s) {
    ...
    function Qt(e, r) {
        ...
        if (i !== null && k(i, HTMLInputElement) && (i.value = r),
        _.isRecaptchaCompatibilityMode) {
    ...
    var st = function() {
            ...
            return r = vt(function(d, o, n, c) {
                ...
                return Ee(this, function(I) {
                    ...
                    case 0:
                        ...
                        w = "https",
                        E = "",
                        O = "".concat(w, "://").concat(l.host, "/cdn-cgi/challenge-platform/").concat(h, "rc/").concat(c).concat(E),
                        I.label = 1;
                    case 1:
                    ...
                    case 2:
                        return C = I.sent(),
                        C.status === 200 ? [3, 3] : (x("Cannot determine Turnstile's embedded location, aborting clearance redemption."),
                        i(d, o, !1),
                        [3, 5]);
                    case 3:
                        return [4, C.json()];
        ...
        function t(d, o, n) {
            if (d.params.retry === se.AUTO || n) {
                d.isExecuted && (d.msgQueue.push(K.EXECUTE),
                d.isExecuted = !0,
                d.isExecuting = !0);
                        ...
                        case "complete":
                            {
                                a.rcV = W,
                                a.response = n.token,
                                n.sToken ? e(a, c, n.sToken, n.chlId) : i(a, c, !1);
                                break
                            }
                        case "fail":
                            {
                                ...
                                if (M) {
                                    var I;
                                    M(String((I = n.code) !== null && I !== void 0 ? I : ht)) || (n.code && x("Error: ".concat(n.code)),
                                    t(a, c, q))
                                } else
                                    n.code ? (t(a, c, q),
                                    m("Error: ".concat(n.code), 3076)) : t(a, c, !1);
                                break
                            }
                        case "feedbackInit":
                            {
        ...
        function g() {
            var d = "abcdefghijklmnopqrstuvwxyz0123456789", o = d.length, n;
            do {
                n = "";
                for (var c = 0; c < 5; c++)
                    n += d.charAt(Math.floor(Math.random() * o))
        ...
        function b(d) {
            ...
            if (n) {
                ...
                n.watchcat.seq = 0,
                n.params.execution === ne.RENDER && (n.msgQueue.push(K.EXECUTE),
                n.isExecuted = !0,
                n.isExecuting = !0);
                var c = X(o)
                ...
                if (n.params.appearance === V.INTERACTION_ONLY && Gt(a),
                n.params.sitekey === null) {
                    m("Unexpected Error: Sitekey is null", 3347);
                    return
                }
                var p;
                a.src = nt(o, n.params.sitekey, n.params, (p = n.rcV) !== null && p !== void 0 ? p : W, oe, "b", tt(n)),
                it(c),
        ...
        function S(d, o) {
            ...
            if (h) {
                ...
                if (!(!D || !B)) {
                    ...
                    N.setAttribute("src", nt(D, C, l, W, oe, "b", tt(ft)));
                    var dt = ["cross-origin-isolated", "fullscreen"], Le;
                    U((Le = (c = document.featurePolicy) === null || c === void 0 || (n = c.features) === null || n === void 0 ? void 0 : n.call(c)) !== null && Le !== void 0 ? Le : [], Ke) && dt.push(Ke),
                    ...
                    if (Zt) {
                        ...
                        ye.type = "hidden";
                        var De;
                        if (ye.name = (De = l["response-field-name"]) !== null && De !== void 0 ? De : It,
                        ye.id = "".concat(B, "_response"),
                        a.appendChild(ye),
                        typeof l["response-field-name"] != "string" && sr(C)) {
        ...
        return {
            ready: function(o) {
                if (_.scriptWasLoadedAsync && (x("turnstile.ready() would break if called *before* the Turnstile api.js script is loaded by visitors"),
                m("Remove async/defer from the Turnstile api.js script tag before using turnstile.ready().", 3857)),
                typeof o != "function" && m('turnstile.ready() expected a "function" argument, got "'.concat(typeof o == "undefined" ? "undefined" : L(o), '"'), 3841),
                o(),
                typeof o != "function" && m('Invalid value for parameter "callback", you must provide a callback function as argument to ready()', 3842),
                _.isReady) {
                    o();
                    return
                }
            ...
            execute: function(o, n) {
                ...
                if (p) {
                    ...
                    if (p.response) {
                        ...
                        p.cbSuccess && p.cbSuccess(p.response, !1);
                        return
                    }
                    ...
                    if (p.isResetting)
                        return;
                    if (p.isInitialized && y(p, c, l),
                    p.isInitialized && p.params.appearance === V.EXECUTE && ot(l, p),
                    p.isExecuting) {
            ...
            getResponse: function(o) {
                ...
                if (typeof o == "undefined") {
                    ...
                    if (c) {
                        ...
                        return p != null && p.isExpired && x("Call to getResponse on a widget that expired, consider refreshing the widget."),
                        (a = _.widgetMap.get(c)) === null || a === void 0 ? void 0 : a.response
                    } else
            ...
            isExpired: function(o) {
                ...
                var h = v(o);
                if (!h)
                    return m("Could not find widget for provided container", 43778),
                    !1;
                var l;
    ...
    function fr(e) {
        ...
        if (s && (Ge(s) ? t.size = s : x('Unknown data-size value: "'.concat(s, '"'))),
        0)
            var g;
        ...
        return w && (Qe(w) ? t.appearance = w : x('Unknown data-appearance value: "'.concat(w, ", expected either: 'always', 'execute', or 'interaction-only'."))),
        t
    }
    var de = !1, A = Wt(), ct;
    _.scriptWasLoadedAsync = (ct = A == null ? void 0 : A.loadedAsync) !== null && ct !== void 0 ? ct : !1;
    A != null && A.params && (ie = A.params.get("compat"),
    (ie == null ? void 0 : ie.toLowerCase()) === "recaptcha" ? window.grecaptcha ? x("grecaptcha is already defined. The compatibility layer will not be enabled") : (x("Compatibility layer enabled"),
    _.isRecaptchaCompatibilityMode = !0,
    window.grecaptcha = st) : ie !== null && x('Unknown value for api.js?compat: "'.concat(ie, '", ignoring')),
    ...
    z && !de && setTimeout(function() {
        typeof window[z] == "function" ? window[z]() : (x("Unable to find onload callback '".concat(z, "' immediately after loading, expected 'function', got '").concat(L(window[z]), "'")),
        setTimeout(function() {
    ...
    Yt && !de ? x("Turnstile already has been loaded. Was Turnstile imported multiple times?") : (Yt && de && (Ht(window.turnstile, _),
    Ze(_, oe),
    (A == null || (Oe = A.params) === null || Oe === void 0 ? void 0 : Oe.get("render")) !== "explicit" && setTimeout(ut, 0)),
    window.turnstile = st,
    de || ((A == null || (Ce = A.params) === null || Ce === void 0 ? void 0 : Ce.get("render")) !== "explicit" && lt.push(ut),
    document.readyState === "complete" || document.readyState === "interactive" ? setTimeout(jt, 0) : window.addEventListener("DOMContentLoaded", jt)));
    var Oe, Ce;
    function $t() {
        var e = !0;
        et(_, e),
